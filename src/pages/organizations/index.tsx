...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'admin.count', 'cron_job.count', 'invitation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('admin', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('cron_job', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'cron_job',
          header: 'Cron Job',
          accessorKey: 'cron_job',
          cell: ({ row: { original: record } }: any) => record?._count?.cron_job,
        }
      : null,
