...
import { getCronJobById } from 'apiSdk/cron-jobs';
import { CronJobInterface } from 'interfaces/cron-job';

function CronJobViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('cron_job', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/cron-jobs/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Task Name" text={data?.task_name} />

                <FormListItem label="Frequency" text={data?.frequency} />

                <FormListItem label="Timing" text={data?.timing} />

                <FormListItem label="Parameters" text={data?.parameters} />
