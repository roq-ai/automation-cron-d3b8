...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Admins', path: '/admins', entity: 'admin', service: AccessServiceEnum.PROJECT, icon: FiShield },
    { name: 'Cron Jobs', path: '/cron-jobs', entity: 'cron_job', service: AccessServiceEnum.PROJECT, icon: FiClock },
    {
      name: 'Invitations',
      path: '/invitations',
      entity: 'invitation',
